  ...
  return (
    <div className="p-5 bg-[#fdfcf9] min-h-screen">
      ...
      {services.map((service) => (
        <Link
          to={`/service/${service.id}`} // Route to the service details page
          key={service.id}
          className="bg-white rounded-lg shadow-md p-5 text-center flex flex-col justify-between relative border border-gray-200 hover:shadow-lg hover:bg-gray-100 transition-transform transform hover:scale-105 no-underline text-inherit"
        >
